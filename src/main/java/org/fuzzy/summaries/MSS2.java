...
public class MSS2 extends MSS1 {
    protected final Summarizer summarizer2;

    public MSS2(String subjectAttribute, String predicate1, String predicate2,
        ...
        super(subjectAttribute, predicate1, predicate2, predicate1Value, predicate2Value,
                quantifier, summarizer);
        this.summarizer2 = summarizer2;
        this.summaryType = "MSS2";
    }
    ...
    public double calculateT1(List<SongRecord> dataset) {
        ...
        for (SongRecord record : p1Records) {
            sigmaCountS2P1 += summarizer2.getMembership(record);
        }
        ...
        double denominator = (sigmaCountS2P1 / m_p1) + (sigmaCountS1P2 / m_p2);
    ...
    public String generateSummary() {
        return String.format("%s | %s %s w odniesieniu do %s będących [%s] jest [%s]",
                summaryType,
                quantifier.getName(),
